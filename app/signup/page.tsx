...
// ============================================================================
// CR AUDIOVIZ AI - UNIFIED SIGNUP PAGE
...
import { Mail, Lock, User, AlertCircle, Check, Loader2, Gift } from 'lucide-react';
import { createClient } from '@/lib/supabase/client';

// OAuth Provider Configuration (same as login)
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center px-4 py-8">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Get started with 50 free credits</p>
        </div>

        {/* Free Credits Banner */}
        <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl p-4 mb-6 flex items-center gap-3">
          <div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center">
            <Gift className="w-5 h-5" />
          </div>
          <div>
            <p className="font-semibold">🎁 50 Free Credits</p>
            <p className="text-sm text-white/80">Use across all 60+ CRAV tools</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <form onSubmit={handleEmailSignup} className="space-y-4">
            ...
            <div>
              ...
              {password.length > 0 && (
                <div className={`flex items-center gap-2 mt-2 text-sm ${passwordStrong ? 'text-green-600' : 'text-yellow-600'}`}>
                  {passwordStrong ? (
                    <Check className="w-4 h-4" />
                  ) : (
                    <AlertCircle className="w-4 h-4" />
                  )}
                  {passwordStrong ? 'Strong password' : 'Password too short'}
                </div>
              )}
            </div>
